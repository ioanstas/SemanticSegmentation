...
This repository contains Jupyter Notebooks (`segmentation_urban.ipynb` and `Urban_cities_segment.ipynb`) for performing Semantic Segmentation on urban driving scenes. It focuses on predicting pixel-level classes for street-view images.
...
2. Open your preferred notebook (`segmentation_urban.ipynb` or `Urban_cities_segment.ipynb`) in Jupyter Notebook, JupyterLab, or VS Code.
